...
//        return employees;
    ...
    //
//    @GetMapping
//    public Iterable<Employee>findAllById(@PathVariable Long id){
//        return repository.findAllById(Iterable<Employee>);
//    }


 /*
    التشييك على الاسم في حال التشابه لا تضيف ال  object
    * */
}
